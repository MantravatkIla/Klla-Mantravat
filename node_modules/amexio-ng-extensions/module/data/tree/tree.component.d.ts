...
export declare class AmexioTreeViewComponent implements AfterViewInit, OnInit {
    element: ElementRef;
    ...
    constructor(element: ElementRef, dataService: CommonDataService, cdf: ChangeDetectorRef);
    ngOnInit(): void;
