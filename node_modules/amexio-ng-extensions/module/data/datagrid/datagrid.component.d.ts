import { AfterContentInit, ChangeDetectorRef, ElementRef, OnInit, QueryList } from '@angular/core';
import { AmexioGridColumnComponent } from './data.grid.column';
import { CommonDataService } from '../../services/data/common.data.service';
export declare class AmexioDatagridComponent implements OnInit, AfterContentInit {
    element: ElementRef;
    ...
    constructor(element: ElementRef, dataTableService: CommonDataService, cd: ChangeDetectorRef);
    ngOnInit(): void;
    ...
    setCheckBoxSelectClass(event: any): string;
    ...
    noGrpBySortOrder(sortOrder: any, x: any, y: any): 1 | -1;
