...
export declare class AmexioCardComponent implements OnInit, AfterViewInit, AfterContentInit {
    headeralign: string;
    header: boolean;
    footer: boolean;
    footeralign: string;
    ...
    amexioHeader: QueryList<AmexioHeaderComponent>;
    headerComponentList: AmexioHeaderComponent[];
    amexioBody: QueryList<AmexioBodyComponent>;
