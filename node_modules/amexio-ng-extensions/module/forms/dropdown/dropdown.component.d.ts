...
export declare class AmexioDropDownComponent implements OnInit, ControlValueAccessor {
    ...
    navigateFilterOptions(): void;
    scrollPositionIndex(event: any): void;
    value: any;
